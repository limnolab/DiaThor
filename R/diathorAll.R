...
diaThorAll <- function(species_df, isRelAb=FALSE, maxDistTaxa = 2, resultsPath, calculateguilds = TRUE, vandam = TRUE, vandamReports = TRUE, singleResult = TRUE, exportFormat = 3, exportName = "DiaThor_results", plotAll = TRUE, color = "#0073C2", updateDBC = TRUE, DBCversion = "12.1"){
  resultmat <- diat_loadData(species_df, isRelAb, maxDistTaxa, resultsPath, updateDBC, DBCversion)
